...
urlpatterns = [
    ...
    path('post/<int:post_id>/comments/<int:pk>/update/', views.CommentUpdateView.as_view(), name='update_comment'),
    path('post/<int:post_id>/comments/<int:pk>/delete', views.CommentDeleteView.as_view(), name='delete_comment'),
]